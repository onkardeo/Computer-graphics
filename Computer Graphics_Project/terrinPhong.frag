...
// INCOMING DATA
uniform vec4 ambient_Material_Color_Terrin;
uniform vec4 ambient_Light_Color;
uniform vec4 diffuse_Material_Color_Terrin;
...
void main()
{
    ...
    ambientParam = ambient_Light_Color * ambient_Material_Color_Terrin * ambient_Reflection_Coefficient;
    
    // Computing diffuse factor.
    diffuseParam = diffuse_Material_Color_Terrin * light_Source_Color * diffuse_Reflection_Coefficient * dot(L, N);
