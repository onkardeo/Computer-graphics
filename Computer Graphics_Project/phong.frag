...
void main()
{
    ...
    ambientParam = ambient_Light_Color * ambient_Material_Color * ambient_Reflection_Coefficient;
    
    // Computing diffuse factor.
    diffuseParam = diffuse_Material_Color * light_Source_Color * diffuse_Reflection_Coefficient * dot(L, N);
