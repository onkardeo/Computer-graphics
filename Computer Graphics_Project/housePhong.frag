...
// INCOMING DATA
uniform vec4 ambient_Material_Color_House;
uniform vec4 ambient_Light_Color;
uniform vec4 diffuse_Material_Color_House;
...
void main()
{
    ...
    ambientParam = ambient_Light_Color * ambient_Material_Color_House * ambient_Reflection_Coefficient;
    
    // Computing diffuse factor.
    diffuseParam = diffuse_Material_Color_House * light_Source_Color * diffuse_Reflection_Coefficient * dot(L, N);
